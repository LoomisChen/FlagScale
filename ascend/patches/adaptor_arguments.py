...
def _add_training_args(parser):
    ...
    group.add_argument('--pre-tokens', type=int, default=None,
                       help='pre-tokens used by Flash attention')
    group.add_argument('--next-tokens', type=int, default=None,
                       help='next-tokens used by Flash attention')
